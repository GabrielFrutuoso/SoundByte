    ...
    <div className="h-full flex flex-col px-12 pt-12 space-y-4">
      <div className="flex items-center gap-4">
        ...
        <div className="flex flex-col gap-3">
          <div>
            <h1 className="text-4xl font-bold">POST HUMAN: NeX GEn</h1>
            <h2 className="text-muted-foreground">Bring Me The Horizon</h2>
          </div>
      ...
      <Table>
        ...
        <TableBody>
          ...
          <TableRow>
            ...
            <TableCell>Top 10 Statues That Cried Blood</TableCell>
            <TableCell>Bring Me The Horizon</TableCell>
            <TableCell>{new Date().toLocaleDateString()}</TableCell>
          ...
          <TableRow>
            ...
            <TableCell>Limousine (com Aurora)</TableCell>
            <TableCell>Bring Me The Horizon</TableCell>
            <TableCell>{new Date().toLocaleDateString()}</TableCell>
          ...
          <TableRow>
            ...
            <TableCell>A Bullet W/ My Name On (com Underoath)</TableCell>
            <TableCell>Bring Me The Horizon</TableCell>
            <TableCell>{new Date().toLocaleDateString()}</TableCell>
          ...
          <TableRow>
            ...
            <TableCell>(OST) (Spi)ritual</TableCell>
            <TableCell>Bring Me The Horizon</TableCell>
            <TableCell>{new Date().toLocaleDateString()}</TableCell>
          ...
          <TableRow>
            ...
            <TableCell>R.I.P. (Duskcore Remix)</TableCell>
            <TableCell>Bring Me The Horizon</TableCell>
            <TableCell>{new Date().toLocaleDateString()}</TableCell>
          ...
          <TableRow>
            ...
            <TableCell>
              Amen! (com Lil Uzi Vert e Daryl Palumbo do Glassjaw)
            </TableCell>
            <TableCell>Bring Me The Horizon</TableCell>
            <TableCell>{new Date().toLocaleDateString()}</TableCell>
          ...
          <TableRow>
            ...
            <TableCell>(OST) P.U.S.S.-E</TableCell>
            <TableCell>Bring Me The Horizon</TableCell>
            <TableCell>{new Date().toLocaleDateString()}</TableCell>
